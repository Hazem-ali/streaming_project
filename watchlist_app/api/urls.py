...
from .views import (MovieDetails, WatchList_APIView, Stream_APIView,
                    StreamPlatformDetails, ReviewList, ReviewDetail, ReviewCreate, StreamPlatform_ViewSet, UserReviewList)
...
urlpatterns = [
    ...
    path('reviews/<str:username>', UserReviewList.as_view(), name='Stream Platform Details'),
    # path('reviews/', UserReviewList.as_view(), name='Stream Platform Details'),


         
    path('stream/<int:pk>/reviews/', ReviewList.as_view(),
